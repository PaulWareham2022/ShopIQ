...
export interface Repository<T extends BaseEntity> {
  ...
  updateMany(conditions: Partial<T>, updates: Partial<Omit<T, 'id' | 'created_at' | 'updated_at'>>): Promise<number>;
...
export type CanonicalDimension = 'mass' | 'volume' | 'count' | 'length' | 'area';
